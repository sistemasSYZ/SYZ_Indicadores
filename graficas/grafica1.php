...
<body>
    <div>
        <div class="grf" style = "margin-top:50px; margin-bottom:10px; margin-left:40px;">
            <h2><?php echo " Grafica de KPI: ".$nombrekpi." del area: ".$area ?></h2>
        </div>
        <div>
            <a href="../menu.php" class="btn btn-info" style = "margin-top:10px; margin-bottom:10px; margin-left:40px;"> Regresar al menu </a>
        </div>
    ...
    <script>
        ...
        <?php
            if (($unidadkpi == "NUMERICO") or ($unidadkpi == "PESOS")) {
        ?>
